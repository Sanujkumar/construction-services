        ...
        <div >
          <Link to="/" className="mx-2 my-1 flex items-center lg:mb-0 lg:mt-0 ">
            <img
              ...
              loading="lazy"
              className="transition-all duration-300 ease-in-out hover:filter hover:gayscale-0 hover:invert hover:brightness-125 h-12 w-8 sm:h-14 sm:w-14 rounded-80p"    
            />
          </Link>  
        </div>  
    );
